...
function showSlide1() {
    ...
    setTimeout(showSlide1, 4850); // Change image every 2 seconds
}
var slideInde2 = 0;
showSlide2();
...
function showSlide2() {
    ...
    setTimeout(showSlide2, 4900); // Change image every 2 seconds
}
var slideInde3 = 0;
showSlide3();
...
function showSlide3() {
    ...
    setTimeout(showSlide3, 4950); // Change image every 2 seconds
}
function openNav() {
